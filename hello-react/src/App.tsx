            ...
            <main className="main">
                <div className="tasks">
                    ...
                    <TaskCard title="Build the website with static content" dueDate="10th April" assigneeName="Rohit S"
                              completedAtDate=""
                    />
                    <TaskCard title="Add blog" dueDate="22nd March" assigneeName="Rohit M" completedAtDate=""/>
                ...
                <div className="tasks">
                    <h1>Done</h1>
                    <TaskCard title="Design the mockup" completedAtDate="10th March" assigneeName="Rohit S" dueDate=""/>
